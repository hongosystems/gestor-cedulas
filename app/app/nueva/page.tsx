...
export default function NuevaCedulaPage() {
  ...
  async function onFileChange(f: File | null) {
    ...
    if (name.endsWith(".docx") || name.endsWith(".pdf")) {
      try {
        // DESACTIVADO: Ya no se extrae información del documento automáticamente
        // La información se completa manualmente o mediante búsqueda por expediente
        // setExtracting(true); // Mostrar loader

        // DESACTIVADO: Microservicio de Render para extraer información de PDFs
